...
<!-- 			<span class="tmo-blogicons">
	...
	<div class="blog-content-wrap">	
		...
		<span class="blog-author">			
			<!-- <i class="fa fa-user-o"></i> -->{l s='By' mod='psblog'}: 
		...
		<div class="blog-shortinfo">
			...
			{if $config->get('listing_show_readmore',1)}
				<div class="readmore">
					<a href="{$blog.link|escape:'html':'UTF-8'}" title="{$blog.title|escape:'html':'UTF-8'}" class="btn btn-primary">{l s='Read more' mod='psblog'}</a>
				</div>
			{/if}
		</div>
