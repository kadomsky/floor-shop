...
//		$links 	   		 =  array();
        ...
        $image_w = (int)$config->get('listing_secondary_img_width', 1000);
        $image_h = (int)$config->get('listing_secondary_img_height', 786);
        ...
        $this->context->smarty->assign(array(
            ...
            'listing_secondary_column' => $config->get('listing_secondary_column', 2),
            'filter' => $condition,
