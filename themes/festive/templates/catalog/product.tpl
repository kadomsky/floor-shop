...
data-toggle="tab"
              ...
              <div class="tab-content" id="tab-content">
               ...
               {/foreach}
                 {hook h='displayTmoProductTabContent' product=$product}
            </div>
          </div>
{/block}
	</section>
    ...
    {block name='product_accessories'}
      {if $accessories}
		...
		{assign var='productsCount' value=count($accessories)}
      ...
      <div class="products-tab-content">
         ...
         <div class="product_accessory"> 
			...
			{foreach from=$accessories item="product_accessory"}
              {block name='product_miniature'}
                <li class="{if $productsCount >= $sliderVal}item{else}product_item col-xs-12 col-sm-6 col-md-4 col-lg-3{/if}">
