...
*}
 ...
 <div id="_desktop_currency_selector">
  <div class="currency-selector dropdown js-dropdown">
    ...
    <span class="expand-more _gray-darker hidden-sm-down" data-toggle="dropdown"><span class="cur_sing">{$current_currency.sign}</span> <span>{$current_currency.iso_code}</span></span>
