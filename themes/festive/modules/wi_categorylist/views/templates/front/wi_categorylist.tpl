...
<div class="row">
		...
		{l s='shop by category' d='Modules.Categorylist.Shop'}
		</h2>
		</div>
		<div id="spe_res">
			<div class="wicategory-container">
							...
							<div class="block_content">
								...
								<div class="categorylist">
									...
									<div class="cate-button">
										<a href="{$link->getCategoryLink($wicategoryinfo.category->id_category, $wicategoryinfo.category->link_rewrite)}">{l s='View Collection' d='Modules.Categorylist.Shop'}</a>
									</div>
									...
									<li>
										<a href="{$link->getCategoryLink($wicategoryinfo.category->id_category, $wicategoryinfo.category->link_rewrite)}">
											{l s='View all' d='Modules.Categorylist.Shop'}</a>
									</li>
								</ul>
								</div>
							</div>
				...
				{else}
					<div class="alert alert-info">{l s='No Category is Selected.' d='Modules.Categorylist.Shop'}</div>
				{/if}
