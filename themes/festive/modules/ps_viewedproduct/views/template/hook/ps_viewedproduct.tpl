...
<section class="viewed-products clearfix">
	...
	<div class="products"> 
		...
		{if $productsCount >= $sliderVal}
			<ul id="wi-viewed-carousel" class="wi-carousel product_list">
		{else}
			<ul id="wi-viewed-grid" class="viewed_grid product_list grid row gridcount">
		{/if}
		...
		{if $productsCount >= $sliderVal}
			<div class="customNavigation">
				<a class="btn prev wi_viewed_prev">&nbsp;</a>
				<a class="btn next wi_viewed_next">&nbsp;</a>
			</div>
		{/if}
		</div>
	</div>
