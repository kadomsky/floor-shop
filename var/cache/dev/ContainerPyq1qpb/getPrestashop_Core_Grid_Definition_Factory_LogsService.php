...
$this->services['prestashop.core.grid.definition.factory.logs'] = $instance = new \PrestaShop\PrestaShop\Core\Grid\Definition\Factory\LogGridDefinitionFactory(${($_ = isset($this->services['prestashop.router']) ? $this->services['prestashop.router'] : $this->load('getPrestashop_RouterService.php')) && false ?: '_'}->generate("admin_common_reset_search", ["controller" => "logs", "action" => "index"]), ${($_ = isset($this->services['prestashop.router']) ? $this->services['prestashop.router'] : $this->load('getPrestashop_RouterService.php')) && false ?: '_'}->generate("admin_logs_index"));
