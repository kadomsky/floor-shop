...
$this->services['prestashop.core.grid.definition.factory.meta'] = $instance = new \PrestaShop\PrestaShop\Core\Grid\Definition\Factory\MetaGridDefinitionFactory(${($_ = isset($this->services['prestashop.router']) ? $this->services['prestashop.router'] : $this->load('getPrestashop_RouterService.php')) && false ?: '_'}->generate("admin_common_reset_search", ["controller" => "meta", "action" => "index"]), ${($_ = isset($this->services['prestashop.router']) ? $this->services['prestashop.router'] : $this->load('getPrestashop_RouterService.php')) && false ?: '_'}->generate("admin_metas_index"));
