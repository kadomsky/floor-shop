...
class __TwigTemplate_57b1f7a7ba0c19fd3b391b5d11d57641d4c919f0878ed5051521e5c2f5442296 extends \Twig\Template
{
...
";
        // line 26
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute(($context["record"] ?? $this->getContext($context, "record")), $this->getAttribute(($context["column"] ?? $this->getContext($context, "column")), "id", []), [], "array"), $this->getAttribute($this->getAttribute(($context["column"] ?? $this->getContext($context, "column")), "options", []), "format", [])), "html", null, true);
        echo "
";
...
", "@PrestaShop/Admin/Common/Grid/Columns/Content/date_time.html.twig", "/home/a0280957/domains/shop.floor-shop.ru/public_html/src/PrestaShopBundle/Resources/views/Admin/Common/Grid/Columns/Content/date_time.html.twig");
    }
}
